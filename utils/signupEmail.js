...
<head>
  ...
  <title>Welcome to MyReelDreams!</title> <!-- The title tag shows in email notifications, like Android 4.4. -->
  <style type="text/css">
  ...
  <table border="0" width="600" cellpadding="0" cellspacing="0" align="center" style="width:600px; margin: auto;" class="email-container">
        ...
        <table border="0" width="100%" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td valign="middle" width="80" style="padding:5px 0; text-align:center; line-height: 0;" class="stack-column-center">
              <a href="https://myreeldream.ai/">
                <img src="https://youblockchainer.infura-ipfs.io/ipfs/QmU3sNvZq4G6hD552J6KcsQLWoFt4MSQMw7R6XBtxkqGk3" alt="MyReelDreams Logo" width="125" height="66" border="0" style="margin: auto;">
              </a>
            </td>
          </tr>
          <tr><td height="5" style="font-size: 0; line-height: 0;">&nbsp;</td></tr>
        ...
        <table border="0" width="100%" cellpadding="0" cellspacing="0" bgcolor="#ffffff">
          ...
          <tr>
            <td style="padding: 4%; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 400; text-rendering: optimizeLegibility; -webkit-font-smoothing: antialiased;line-height: 26px; color: #5a6066;">
              Welcome to myreeldream.ai !<br/ >
              You made the right choice for a life changer !<br />
              Stay tuned for excited news to come !
            </td>
          </tr>
    ...
    <tr>
      <td valign="middle" width="80" style="padding: 16px 0; text-align:center; line-height: 0; border-top: 1px solid #ebedf0;" class="stack-column-center">
        <a href="https://myreeldream.ai/">
          <img src="https://youblockchainer.infura-ipfs.io/ipfs/QmRSFzgz5qMUAH7NWxEtwxtmy3MXWbs4LShHaLqMzE9nUv" alt="MyReelDreams Logo" width="125" height="66" border="0" style="margin: auto;" disabled>
        </a>
      </td>
    </tr>
    <tr>
      <td style="text-align:center; padding: 0 0 16px 0; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 400; text-rendering: optimizeLegibility; -webkit-font-smoothing: antialiased;line-height: 26px; color: #5a6066;">
        <span class="mobile-link--footer">
          support@myreeldream.ai<br />
          113 B Paola Road, Tarxien 1807 Malta 🇲🇹
        </span>
        <br>
      </td>
    </tr>
    <!-- <tr>
      <td style="text-align:center; padding: 0 0 16px 0; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 400; text-rendering: optimizeLegibility; -webkit-font-smoothing: antialiased;line-height: 26px; color: #5a6066;">
        <a class="mobile-link--footer" href="https://dribbble.com/myreeldream" style="padding: 0 5px"><img src="http://bernar.d.pr/12kDa+" alt="Dribble Logo" width="18" height="18" border="0" style="margin: auto;"></a>
        <a class="mobile-link--footer" href="https://www.facebook.com/myreeldream" style="padding: 0 5px"><img src="http://bernar.d.pr/1cGSX+" alt="Facebook Logo" width="18" height="18" border="0" style="margin: auto;"></a>
        <a class="mobile-link--footer" href="https://twitter.com/myreeldream" style="padding: 0 5px"><img src="http://bernar.d.pr/11TjR+" alt="Twitter Logo" width="18" height="18" border="0" style="margin: auto;"></a>
      </td>
    </tr> -->
    <tr>
      <td style="text-align:center; padding: 0 0 16px 0; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 400; text-rendering: optimizeLegibility; -webkit-font-smoothing: antialiased;line-height: 26px; color: #5a6066;">
